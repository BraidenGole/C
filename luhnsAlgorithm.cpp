 ...
 *      have a sum __eq__ to 20 which means that there is a zero on
 *      the end of the number which suggest the credit card number
 *      is valid.
 */
#include <stdio.h>
#include <stdlib.h>
 ...
 *                      was found on the end of the total sum if so,
 *                      then the credit card has been validated.
