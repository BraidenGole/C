/*
    ...
    DESCRIPTION     :   This is the application of luhns algorithm. This does not entirely
                        ...
                        NOTE: There are numbers from MASTERCARD that wont validate
                        any master card that starts with a 22.

*/
#include <stdio.h>
#include <string.h>

#define KMASTRCARDNUMBERS 7
                ...
                */
                ...
                {   
                    ...
                    */
                    ...
                    // Checks the secondDigit with checkMstrCardDigit.
                    short checkMstrCardDigit = 0;
                    ...
                    {   
                        for (checkMstrCardDigit; checkMstrCardDigit < KMASTRCARDNUMBERS; ++checkMstrCardDigit)
                        {   
                            if (secondDigit == checkMstrCardDigit)
                            {
                                printf("MASTERCARD\n");
                                return 0;
                            }
