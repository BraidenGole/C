 ...
 *  PARAMETERS      :   ppWeaponHead
 *  RETURNS         :   None
 */
void wipeWeaponWheel(struct Weapon** ppWeaponHead)
{
    struct Weapon* pThisWeapon = NULL;
    struct Weapon* pNextWeapon = NULL;

    pThisWeapon = *ppWeaponHead;
    ...
    } while (pThisWeapon != *ppWeaponHead);
}
 ...
 *  RETURNS         :   None
 */
void showWeaponWheel(struct Weapon** ppWeaponHead)
{   
    struct Weapon* pWheel = *ppWeaponHead;
    while (pWheel->pNext != *ppWeaponHead)
    {
