...
/**     -- Function header comment
 *  FUNCTION        :   clearTheNames
 *  DESCRIPTION     :   This function will initialize all of
 *                      the entries to NULL clearing their contents.
 *  PARAMETERS      :   arspHashTable[KTABLELIMIT] 
 *  RETURNS         :   None
 */
...
{   
    int iNamesToClear = 0;
    while (iNamesToClear < KTABLELIMIT)
    {   
        arspHashTable[iNamesToClear] = NULL;
        ++iNamesToClear;
    }
}